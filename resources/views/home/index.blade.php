                            ...
                            <div class="row h-100">
                                <div
                                    ...
                                    <p
                                        ...
                                        We are a creative company that focuses on long term relationships with
                                        customers.</p>
                        ...
                        <div class="container h-100">
                            <div class="row h-100">
                                <div
                                    ...
                                    <p
                                        class="lead fs-23 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-2s">
                                        We make sure your spending is stress free so that you can have the perfect
                                        control.</p>
                                    <div class="animate__animated animate__slideInUp animate__delay-3s"><a href="#"
        ...
        <div class="container py-14 py-md-16">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-6">Cum sociis natoque penatibus et magnis dis parturient montes,
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-6">Nullam id dolor id nibh ultricies vehicula ut id elit. Vestibulum id
                        ligula porta felis euismod semper. Aenean lacinia bibendum nulla sed consectetur. Sed
                        posuere consectetur est at lobortis. Vestibulum id ligula porta felis.</p>
                                ...
                                <div class="swiper-slide">
                                    <blockquote class="icon fs-lg">
                                        <p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                                            ...
                                            consectetur nulla dapibus curabitur blandit faucibus.”</p>
                                ...
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-2">Fermentum massa justo sit amet risus morbi
                                                leo.</p>
        ...
        <div class="container py-14 py-md-16 text-center">
            <div class="row">
                <div class="col-md-9 col-lg-7 col-xl-7 mx-auto text-center">
                    ...
                    <p class="lead fs-lg mb-6 px-xl-10 px-xxl-15">We are trusted by over 5000+ clients. Join them
